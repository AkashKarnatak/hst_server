...
func NewStartupController(coll *mongo.Collection) *StartupController {
  return &StartupController{coll}
}

func (mc *StartupController) GetStartups(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
